...
import com.example.roomtestproject.databinding.FragmentAddNoteBinding
...
class AddNoteFragment : Fragment() {
    ...
    private fun init() {
        val vieModel = ViewModelProvider(this)[AddNoteViewModel::class.java]
        binding.btnAddNote.setOnClickListener {
            val title = binding.etAddTitle.text.toString()
            val description = binding.etAddDesc.text.toString()
            vieModel.insert(NoteModel(title = title, description = description)){}
